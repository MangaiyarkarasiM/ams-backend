...
router.get("/getAllMaintenanceDetails", authVerify, async (req, res) => {
  try {
...
router.get("/:serialNumber", authVerify, async (req, res) => {
  try {
    const details = await MaintenanceDetails.findOne({
...
router.get("id/:id", authVerify, async (req, res) => {
  try {
...
router.put("/:id", authVerify, async (req, res) => {
  try {
    const details = await MaintenanceDetails.updateOne(
      { _id: req.params.id },
      req.body
    );
    res.send({
